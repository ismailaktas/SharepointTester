...
class SharePointAPI {
	...
	public function __construct ($spUsername, $spPassword, $spWsdl, $mode = 'STANDARD', $options = array()) {
		...
		if (!empty($this->spUsername)) {
			...
			//echo dirname(dirname(dirname(dirname(dirname(__FILE__))))).'/certs/dacka.pem';
			
			//$options['local_cert'] = dirname(dirname(dirname(dirname(dirname(__FILE__))))).'/certs/dacka.pem';
		}
